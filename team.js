...
Thanks to Me ( DARK-DEVIL)
 👺✨Who Helped Assemble This Sexy Script .BF!!`,unicorn, [{"urlButton": {"displayText": `${button}`,"url": `${btnurl}`}},{"urlButton": {"displayText": "My GITHUB🔖","url": `https://github.com/malindunimsara`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
